...
{{< socialBadges github="hao-ai-lab/FastVideo" demo="https://dreamverse.fastvideo.org/" slack="https://join.slack.com/t/fastvideo/shared_invite/zt-3sbq6wr37-TozNr4xtGHOoa4byxFXmPg" discord="https://discord.gg/Dm8F2peD3e" >}}
...
We think there is a better interface for AI video generation, which is why we created [**Dreamverse**](https://dreamverse.fastvideo.org/), an interface that enables a new workflow called **vibe directing**. 
...
**Contributors:** [Shao Duan](https://github.com/shaoxiongduan), [Minshen Zhang](https://alexzms.github.io), [Loay Rashid](https://github.com/loaydatrain), [Kevin Lin](https://github.com/kevin314)  
